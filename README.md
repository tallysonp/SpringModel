...
* In `jboss-as-spring-mvc-context.xml` `<context:component-scan base-package="br.com.drummonds.mvc.controller"/>` and `<mvc:annotation-driven/>` are used to register both the non-rest and rest controllers.
